...
import static br.com.join.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static br.com.join.test.util.OAuth2TestUtil.authenticationToken;
import static br.com.join.test.util.OAuth2TestUtil.registerAuthenticationToken;
